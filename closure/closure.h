...
#define clo_apply0(clo) (assert(clo->argc == 1), clo->fn.fn1(clo->env[0]))
#define clo_apply1(clo, arg0) (assert(clo->argc == 2), clo->fn.fn2(clo->env[0], arg0))
#define clo_apply2(clo, arg0, arg1) (assert(clo->argc == 3), clo->fn.fn3(clo->env[0], arg0, arg1))
#define clo_apply3(clo, arg0, arg1, arg2) (assert(clo->argc == 4), clo->fn.fn4(clo->env[0], arg0, arg1, arg2))
#define clo_apply4(clo, arg0, arg1, arg2, arg3) (assert(clo->argc == 5), clo->fn.fn5(clo->env[0], arg0, arg1, arg2, arg3))
#define clo_apply5(clo, arg0, arg1, arg2, arg3, arg4) (assert(clo->argc == 6), clo->fn.fn6(clo->env[0], arg0, arg1, arg2, arg3, arg4))
#define clo_apply6(clo, arg0, arg1, arg2, arg3, arg4, arg5) (assert(clo->argc == 7), clo->fn.fn7(clo->env[0], arg0, arg1, arg2, arg3, arg4, arg5))
#define clo_apply7(clo, arg0, arg1, arg2, arg3, arg4, arg5, arg6) (assert(clo->argc == 8), clo->fn.fn8(clo->env[0], arg0, arg1, arg2, arg3, arg4, arg5, arg6))
#define clo_apply8(clo, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) (assert(clo->argc == 9), clo->fn.fn9(clo->env[0], arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7))
#define clo_apply9(clo, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) (assert(clo->argc == 10), clo->fn.fn10(clo->env[0], arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8))
#define clo_apply10(clo, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) (assert(clo->argc == 11), clo->fn.fn11(clo->env[0], arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9))
#define clo_apply11(clo, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) (assert(clo->argc == 12), clo->fn.fn12(clo->env[0], arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10))
#define clo_apply12(clo, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11) (assert(clo->argc == 13), clo->fn.fn13(clo->env[0], arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11))
#define clo_apply13(clo, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12) (assert(clo->argc == 14), clo->fn.fn14(clo->env[0], arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12))
#define clo_apply14(clo, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13) (assert(clo->argc == 15), clo->fn.fn15(clo->env[0], arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13))
#define clo_apply15(clo, arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14) (assert(clo->argc == 16), clo->fn.fn16(clo->env[0], arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14))

/* 
 * Closure size given the environment parameter count.
 * This is sometimes useful when you want to stack allocate an intermediate closure.
 */
#define clo_size(argn) (sizeof(struct clo) + (argn) * sizeof(val_t))
